...
De esta grafica el dato que podemos observar al es encremento despues de un ano en baja, la suma de administradores que se fueron agregando cada ano, y vemos que en los ultimos anos estaria lateral o la cantidad de administradores se mantiene. 
...
En este caso podemos ver que la proporcion de administrativos por semestre no es tan relevantes por que tienden a ser casi iguales 
...
Las conclusiones de esta grafica son que las 3 universidades con mayor cantidad de administrativos son la U. Javeriana, U. Minuto de dios y la U. de los Andes con sus respectivas cantidades
...
En este caso podemos observar que los departamentos que mas administrativos tiene es bogota dc, seguido por antioquia y tercero valle del cauca

## Vemos la cantidad de administrativos encada departamento 
...
Vemos que el secctor que mas administrativos tiene es el sector privado con 650259 administrativos
